...
SECRET_KEY = 'django-insecure-7b@ofvj3^j8s-f8(74i=$7pzvuu2em$tuw@xld%u-in-lm366m'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'django.template.context_processors.request',
                'controller.context_processors.user_groups',
            ],
        },
    },
]
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR, "controller/static")]
